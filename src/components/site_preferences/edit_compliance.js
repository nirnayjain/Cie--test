...
class EditCompliance extends React.Component {
    ...
    async componentDidMount() {
        ...
        let res = await axios.get(`https://cie-backend-api.herokuapp.com/compliance/get_compliance_ById/${_id}`);
    ...
    handleSubmit(e) {
        ...
        axios
            .put(
                `https://cie-backend-api.herokuapp.com/compliance/edit_compliance/${_id}`,
                data
            )
            .then((res) => {
                console.log(res.data);
