...
class Gallery extends React.Component {
  ...
  componentDidMount() {
    axios.get(`https://api.cie.telangana.gov.in/photo/fetch`).then((res) => {
      const blogs = res.data.reverse();
      console.log(blogs);
      this.setState({ blogs, loading: true });
    });
    this.unsubscribe = axios
      .get(`https://api.cie.telangana.gov.in/photo/fetch`)
      .then((res) => {
        const blogs = res.data.reverse();
        console.log(blogs);
        this.setState({ blogs, loading: true });
  ...
  deleteItem(_id) {
    swal({
      ...
      if (willDelete) {
        console.log(_id);
        axios
          .delete(`https://api.cie.telangana.gov.in/photo/delete/${_id}`)
          .then((res) => {
            console.log(res);
