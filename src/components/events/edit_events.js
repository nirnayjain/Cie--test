...
class EditEvent extends React.Component {
    ...
    async componentDidMount() {
        ...
        let res = await axios.get(`https://cie-backend-api.herokuapp.com/blog/get_event_ById/${_id}`);
        ...
        let resCat = await axios.get(`https://cie-backend-api.herokuapp.com/blog/get_event_cat`)
        const eventCategories = resCat.data;
        console.log(eventCategories);
        this.setState({ eventCategories });
        let resType = await axios.get(`https://cie-backend-api.herokuapp.com/blog/get_event_type`)
    ...
    handleSubmit(e) {
        ...
        if (this.validator.allValid()) {
            ...
            axios
                .put(
                    `https://cie-backend-api.herokuapp.com/blog/update_event/${_id}`,
                    formdata
                )
                .then((res) => {
                    console.log(res.data);
            ...
            <div>
                ...
                <div className="admin-wrapper col-12">
                    <div className="admin-content">
                        <div className="admin-head">Course - Edit</div>
