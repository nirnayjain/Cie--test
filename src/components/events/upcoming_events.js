...
class EventUpcoming extends React.Component {
    ...
    componentDidMount() {
        ...
        axios
            .get(`https://cie-backend-api.herokuapp.com/blog/get_all_events`)
            .then((res) => {
    ...
    deleteItem(_id) {
        swal({
            ...
            if (willDelete) {
                ...
                axios
                    .delete(
                        `https://cie-backend-api.herokuapp.com/blog/delete_event/${_id}`
                    )
                    .then((res) => {
                        console.log(res);
            ...
            <div>
                ...
                <div className="admin-wrapper col-12">
                    <div className="admin-content">
                        <div className="admin-head">Upcoming Courses</div>
