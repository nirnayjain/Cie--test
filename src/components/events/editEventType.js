...
class EditEventType extends React.Component {
    ...
    componentDidMount() {
        ...
        axios
            .get(
                `https://cie-backend-api.herokuapp.com/blog/get_event_typeById/${_id}`
            )
            .then((res) => {
    ...
    handleSubmit(e) {
        ...
        if (this.validator.allValid()) {
            ...
            axios
                .put(
                    `https://cie-backend-api.herokuapp.com/blog/update_event_type/${_id}`,
                    blogcategory
                )
            ...
            <div>
                ...
                <div className="admin-wrapper col-12">
                    <div className="admin-content">
                        <div className="admin-head">Edit Course Type</div>
                        {this.state.loading ? (
