...
class EditCarousal extends React.Component {
  ...
  componentDidMount() {
    ...
    console.log(id);
    axios
        .get(`https://cie-backend-api.herokuapp.com/carousal/fetch/${id}`)
        .then((res) => {
            const data = res.data;
            console.log(data);
  ...
  handleSubmit(e) {
    ...
    if (this.validator.allValid()) {
      ...
      axios
        .put(
          `https://cie-backend-api.herokuapp.com/carousal/save/${id}`,
          formdata
        )
        .then((response)=> {
          // handle success          
      ...
      <div>
        ...
        <div className="admin-wrapper col-12">
          <div className="admin-content">
            <div className="admin-head">Carousal Image - Edit</div>
