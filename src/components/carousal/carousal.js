...
class Carousal extends React.Component {
  ...
  componentDidMount() {
    axios.get(`carousal/fetch`).then((res) => {
      const blogs = res.data.reverse();
      console.log(blogs);
      this.setState({ blogs, loading: true });
    });
    this.unsubscribe = axios.get(`carousal/fetch`).then((res) => {
      const blogs = res.data.reverse();
      console.log(blogs);
      this.setState({ blogs, loading: true });
    });
  ...
  deleteItem(_id) {
    swal({
      ...
      if (willDelete) {
        console.log(_id);
        axios.delete(`carousal/delete/${_id}`).then((res) => {
          console.log(res);
        ...
        return (
          <tr key={index}>
            ...
            <td>
              ...
              <Link to={`/edit_carousal/${blog._id}`}>
      ...
      <div>
        ...
        <div className="admin-wrapper col-12">
          <div className="admin-content">
            <div className="admin-head">Carousal Images</div>
