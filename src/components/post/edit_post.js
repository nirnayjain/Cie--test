...
class EditPost extends React.Component {
  ...
  componentDidMount() {
    ...
    console.log(_id);
    axios
      .get(`https://cie-backend-api.herokuapp.com/update_post/${_id}`)
      .then((res) => {
  ...
  //   axios
  //     .get(
  //       `https://cie-backend-api.herokuapp.com/admin/submenuvalues/${selectedMenuName}`
  //     )
  //     .then((res) => {
  ...
  handleSubmit(e) {
    ...
    if (this.validator.allValid()) {
      ...
      axios
        .put(
          `https://cie-backend-api.herokuapp.com/update_post_patch/${_id}`,
          post
        )
