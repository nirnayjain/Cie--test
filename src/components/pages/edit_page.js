...
class EditPage extends React.Component {
    ...
    async componentDidMount() {
        ...
        let menuRes = await axios.get(`https://cie-backend-api.herokuapp.com/admin/menus`)
        const menus = menuRes.data;
        this.setState({ menus });
        let submenuRes = await axios.get(`https://cie-backend-api.herokuapp.com/admin/submenus`)
